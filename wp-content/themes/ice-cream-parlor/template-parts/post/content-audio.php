...
<?php
  ...
  if ( false === strpos( $ice_cream_parlor_content, 'wp-playlist-script' ) ) {
    $audio = get_media_embedded_in_content( $ice_cream_parlor_content, array( 'audio' ) );
  }
?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      <div class="page-box">
        ...
        <div class="box-content mt-2 text-center">
          ...
          <div class="box-info">
              <?php 
              $ice_cream_parlor_blog_archive_ordering = get_theme_mod('blog_meta_order', array('date', 'author', 'comment', 'category'));
              foreach ($ice_cream_parlor_blog_archive_ordering as $ice_cream_parlor_blog_data_order) : 
                  ...
                  <?php elseif ('comment' === $ice_cream_parlor_blog_data_order) : ?>
                      ...
                      <a href="<?php comments_link(); ?>" class="entry-comments">
                          <?php comments_number(__('0 Comments', 'ice-cream-parlor'), __('1 Comment', 'ice-cream-parlor'), __('% Comments', 'ice-cream-parlor')); ?>
                      </a>

	...
	<main id="tp_content" role="main">
		<div id="primary" class="content-area">
			<div class="page-header">
				<?php if ( have_posts() ) : ?>
					<h1 class="page-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s', 'ice-cream-parlor' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
				<?php else : ?>
					<h1 class="page-title"><?php echo esc_html(get_theme_mod('ice_cream_parlor_edit_no_result_title',__('Nothing Found','ice-cream-parlor')));?></h1>
				<?php endif; ?>
			</div>		
			<?php
	        $ice_cream_parlor_sidebar_layout = get_theme_mod( 'ice_cream_parlor_sidebar_post_layout','right');
		          	...
		          	<div class="col-lg-8 col-md-8 singlepage-main">
			            ...
			            <?php if ( have_posts() ) :
							...
							endwhile; // End of the loop.
								...
								<p><?php echo esc_html(get_theme_mod('ice_cream_parlor_edit_no_result_text',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','ice-cream-parlor')));?></p>
								<?php
									get_search_form();
		    ...
		    <?php }else if($ice_cream_parlor_sidebar_layout == 'three-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($ice_cream_parlor_sidebar_layout == 'four-column'){ ?>
		        <div class="row m-0">
		          	<div class="col-lg-3 col-md-3" id="theme-sidebar"><?php get_sidebar(); ?></div>
		    ...
		    <?php }else if($ice_cream_parlor_sidebar_layout == 'grid'){ ?>
		        <div class="row m-0">
